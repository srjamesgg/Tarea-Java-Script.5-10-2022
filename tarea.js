...
function tienenMismaLongitud(str1, str2) {
  ...
  let array = ["buenas", "el ferxxo", "salio", "a las 5.10"];
  ...
  agregarItemAlFinalDelArray(array,"plis");
  ...
  verificarPassword(usuario.password, 'Me encanta JS!');
  ...
  actualizarPassword(usuario.password, 1234);
  ...
  const agregarAmigo = (usuario, nuevoAmigo) => {
    ...
    usuario = {
      ...
      amigos: ['pedro', 'sebastian', nuevoAmigo]
